...
void bhv_star_door_loop_2(void) {
    ...
    if (gMarioCurrentRoom != 0) {
        if (o->oDoorUnkF8 == gMarioCurrentRoom ||
            gMarioCurrentRoom == o->oDoorUnkFC ||
            gMarioCurrentRoom == o->oDoorUnk100 ||
            gDoorAdjacentRooms[gMarioCurrentRoom][0] == o->oDoorUnkFC ||
            gDoorAdjacentRooms[gMarioCurrentRoom][0] == o->oDoorUnk100 ||
            gDoorAdjacentRooms[gMarioCurrentRoom][1] == o->oDoorUnkFC ||
            gDoorAdjacentRooms[gMarioCurrentRoom][1] == o->oDoorUnk100) {
            sp4 = 1;
        }
    } else {
        sp4 = 1;
